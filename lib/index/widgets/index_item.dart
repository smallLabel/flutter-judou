...
class _IndexPageItemState extends State<IndexPageItem> with AutomaticKeepAliveClientMixin {
  ...
  Stack headerView() => Stack(
    children: <Widget>[
      ...
      Positioned(
        child: Text(day, style: TextStyle(fontSize: 99, color: Colors.white),),
        bottom: -50,
        left: 20,
      ),
